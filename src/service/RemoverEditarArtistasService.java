...
public class RemoverEditarArtistasService {
    ...
    public void removerOuEditar(Scanner sc, ArtistaRepository artistaRepository) {
        if(!artistaRepository.listarArtistasArmazenados().isEmpty()){
            System.out.println("""
                ------------------------------
            ...
            switch (opcaoEscolhida) {
                case 1:
                    ...
                    System.out.println("Nome do artista editado com sucesso!!");
                    break;
                case 2:
                    ...
                    if (generoMusicalEscolhido != generoMusicalAtual) {
                        while (generoMusicalEscolhido != generoMusicalAtual) {
                            ...
                            if (generoMusicalAtual == generoMusicalEscolhido) {
                                ...
                                System.out.println("Genero musical trocado com sucesso!!");
                            }
                        }
                    }
                    break;
            ...
            System.out.println("Erro!! Não existe artistas para serem removidos ou editados!!");
        }
        System.out.println("------------------------------");
    }
}
